...
class __TwigTemplate_a1fff7cbf69488808e655a5f6c12109c0da0e206dce77ba024ad8a0cbde9ef52 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class = \"fill\">
    <div class = \"container\">
        <h2> Fill in information Student </h2>
        ...
        <div class = \"mssv\">
            ";
        // line 25
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 25, $this->source); })()), "mssv", [], "any", false, false, false, 25), 'row');
        echo "
        ...
        echo "
                ";
        // line 32
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 32, $this->source); })()), "phone", [], "any", false, false, false, 32), 'row');
        echo "
            </div>
        ...
        echo "
                ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "address", [], "any", false, false, false, 37), 'row');
        echo "
            </div>
        </div>
        ";
...
";
    ...
    {
        return array (  113 => 49,  105 => 40,  99 => 37,  95 => 36,  88 => 32,  84 => 31,  75 => 25,  69 => 22,  64 => 20,  43 => 1,);
    }
...
", "student/edit.html.twig", "/home/dat96/symfonyBasic/templates/student/edit.html.twig");
    }
}
