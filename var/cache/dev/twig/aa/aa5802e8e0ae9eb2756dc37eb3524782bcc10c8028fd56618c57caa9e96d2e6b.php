...
class __TwigTemplate_5ab262fe0efdabc95a63f528708b193467522df5886487d1f43f7419247e6e77 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        echo "</span></a>
            ...
            <li><a href=\"\" title=\"Banking & Insurance apps\">
                    ...
                    <span class=\"text\">";
        // line 107
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["student"]) || array_key_exists("student", $context) ? $context["student"] : (function () { throw new RuntimeError('Variable "student" does not exist.', 107, $this->source); })()), "address", [], "any", false, false, false, 107), "html", null, true);
        echo "</span></a>
                <div class=\"clearfix\"></div>
            </li>
...
";
    ...
    {
        return array (  163 => 107,  155 => 102,  147 => 97,  139 => 92,  131 => 87,  43 => 1,);
    }
